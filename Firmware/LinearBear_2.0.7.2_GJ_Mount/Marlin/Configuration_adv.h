...
// @section lcd
  ...
  #define MANUAL_FEEDRATE { 50*60, 50*60, 4*60, 60 } // (mm/m) Feedrates for manual moves along X, Y, Z, E from panel
 ...
 */
  ...
  #define SENSORLESS_HOMING // StallGuard capable drivers only
    ...
    #define X_STALL_SENSITIVITY  124
    #define X2_STALL_SENSITIVITY X_STALL_SENSITIVITY
    #define Y_STALL_SENSITIVITY  124
...
#define CUSTOM_USER_MENUS
  ...
  #define USER_SCRIPT_DONE "M117 Command Completed"
