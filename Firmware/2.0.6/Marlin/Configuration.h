...
#define STRING_CONFIG_H_AUTHOR "(Gerd Jentz, SKR V1.4 TURBO PINDA BMG)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "LinearBear"
...
#define PID_K1 0.95      // Smoothing factor within any PID loop
  ...
  //GJ SKR Bear Mosquito PID tune 230°C bei fan=100%
  //#define DEFAULT_Kp 30.95
  //#define DEFAULT_Ki 4.66
  //#define DEFAULT_Kd 51.43

 //GJ LinearBear Copperhead PID tune 230°C bei fan=100%
 ...
 *                                      X, Y, Z, E0 [, E1[, E2...]]
 */
#define DEFAULT_AXIS_STEPS_PER_UNIT   { 100, 100, 400, 815 }  // X+Y+Z 16 steps 1.8°, E 32 steps 1.8°
...
// The size of the print bed GERD
...
//#define DEBUG_LEVELING_FEATURE
  ...
  // Set the number of grid points per dimension. Gerd GRIDPOINTS
...
// For DELTA this is the top-center of the Cartesian print volume. GERD
...
#define NOZZLE_PARK_FEATURE
  ...
  // Specify a park position as { X, Y, Z_raise } GERD
  //#define NOZZLE_PARK_POINT { (X_MAX_POS - 10), (Y_MIN_POS + 10), 20 }
  #define NOZZLE_PARK_POINT { 10, 105, 20 }
...
/**
 * Info Screen Style (0:Classic, 1:Prusa) GERD
 *
 * :[0:'Classic', 1:'Prusa']
 */
